...
if __name__ == "__main__":
    ...
    with open('/Users/markpp/Desktop/output.txt', 'wb') as text_file:
        for point in startPoints:
            ...
            timeString = str(timePoint.tm_mday).zfill(2) + '-' + str(timePoint.tm_mon).zfill(2) + '-' + str(timePoint.tm_year).zfill(4) + ' ' + str(timePoint.tm_hour).zfill(2) + ':' + str(timePoint.tm_min).zfill(2) + ':' + str(timePoint.tm_sec).zfill(2) + '\n'
